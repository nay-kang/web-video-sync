...
function connect() {
  ...
  serverUrl = scheme + "://" + myHostname + "/ws/";
...
async function createPeerConnection() {
  ...
  myPeerConnection = new RTCPeerConnection({
    iceServers: [     // Information about ICE servers - Use your own!
        ...
        {
            urls: "turn:" + myHostname+":3478",  // A TURN server
            username: "test",
            credential: "test"
        }
    ]
...
async function sync_call(evt) {
  ...
  if (myPeerConnection) {
    ...
    log("Setting up connection to invite user: " + room_id);
...
async function handleVideoOfferMsg(msg) {
  ...
  log("Received video chat offer from " + room_id);
  if (!myPeerConnection) {
    createPeerConnection();
  }
...
//     document.getElementById("video").srcObject = webcamStream;
